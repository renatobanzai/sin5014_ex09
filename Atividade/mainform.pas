...
type
  ...
  TJPEGExampleForm = class(TForm)
    ...
    procedure ImageGroupBoxClick(Sender: TObject);
...
begin
  ...
  Image1.Canvas.FillRect(1,1,Image1.Width-1,Image1.Height-1); // this will create the brush handle with the currently active theme brush for hint windows
  Image1.Canvas.Pen.Color:=RGBToColor(0,0,0);
    plotaEixos;
  Image1.Canvas.Pen.Color:=RGBToColor(0,0,255);
    plotCruveImp;
end;
...
procedure TJPEGExampleForm.ImageGroupBoxClick(Sender: TObject);
begin
